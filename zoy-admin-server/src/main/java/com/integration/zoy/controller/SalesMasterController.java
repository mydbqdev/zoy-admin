	    ...
	    try {
	    	...
	    	Email email = new Email();
	            ...
	            String message = "<p>Hi " + master.getFirstName() + " " + master.getLastName() + ",</p>"
	                    + "<p>Welcome to Zoy Sales Portal, We are excited to have you as part of our community! "
	                    + "Below are your sign-in credentials for accessing your account.</p>"
	                    + "<p>Username: " + adminSalesUserLoginDetails.getUserEmail()
	                    + "<br>Password: <b>" + plainPassword + "</b><br>"
//	                    + "Zoy Sales App Sign-in Link : <a href='" + qaSigninLink + "'>" + qaSigninLink + "</a></p>"
...
//	        }
//
//	        // 3. Fetch existing login details (must exist)
...
//	        // 4. Send email with EXISTING credentials (no password change)
//	        sendLogInInfoToUser(loginDetails, ); // Modify email content as needed
//
//
