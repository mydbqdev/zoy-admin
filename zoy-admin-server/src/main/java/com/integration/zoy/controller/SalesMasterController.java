...
public class SalesMasterController implements SalesMasterImpl {
	...
	@Autowired
	private TicketSmartService ticketSmartService;
	...
	public ResponseEntity<String> zoyAdminSalesCreateUser(ZoyPgSalesMasterModel pgSalesMasterModel) {
		...
		try {
			...
			Boolean userCreated=zoyAdminTicketSmartService.createTicketSmartUser(pgSalesMasterModel);
			log.info(userCreated.equals(Boolean.TRUE) ? "Ticket smart user created" : "Ticket smart user not created");
