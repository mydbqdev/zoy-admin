...
@Component({
	selector: 'app-all-closed-tickets',
	templateUrl: './all-closed-tickets.component.html',
	styleUrls: ['./all-closed-tickets.component.css']
})
export class AllClosedTicketsComponent implements OnInit, AfterViewInit {
	...
	displayedColumns: string[] = ['ticket_id', 'created_date','ticket_raisedby','ticket_type', 'priority','assign_name', 'closedOn','status','action'];
	...
	ngAfterViewInit() {
		...
		this.sidemenuComp.activeMenu(6, 'all-closed-tickets');
