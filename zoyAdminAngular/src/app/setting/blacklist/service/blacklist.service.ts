...
export class BlackListService {
  ...
  getBlacklistDetails(data : any): Observable<any>{
    let url1=this.basePath +'zoy_admin/blacklisted';
  ...
  saveBlacklisted(data:any): Observable<any> {
  const url1=this.basePath +"zoy_admin/save_blacklisted";
        return this.httpclient.post<any>(
            url1,
            data,
            {
...
deleteBlacklisted(data : any){
  let url1=this.basePath + "zoy_admin/delete_blacklisted" ;
