...
export class MenuService {
  ...
  private menuList: Menu[] = [
    ...
    { name: "New/my Tickets", link: "/tickets", permission: "TICKETS_READ", icon:"fas fa-chart-bar" },
...
getAllMenus(): Menu[] {
  ...
  private authorization:{ key: string; screen: string; order: number }[] = [
    ...
    { key: "VENDOR MANAGEMENT", screen: "Vendor Management" ,order:2.4 },
    ...
    { key: "TICKETS", screen: "New/My Tickets" ,order:5.1 },
    { key: "MY CLOSED TICKETS", screen: "My Closed Tickets" ,order:5.2 },
    { key: "ALL TICKETS", screen: "All Tickets" ,order:5.3 },
    { key: "ALL CLOSED TICKETS", screen: "Closed Tickets" ,order:5.4 },
