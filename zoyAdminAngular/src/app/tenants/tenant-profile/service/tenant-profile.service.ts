  ...
  export class TenantProfileService{
    ...
    constructor(private httpclient:HttpClient,@Inject(BASE_PATH) private basePath:string, private messageService:MessageService){
     ...
     public getPaymentHistory(): Observable<any> {
          const url1=this.basePath +"zoy_admin/getPaymentHistory";
    ...
    public getDueHistory(): Observable<any> {
      const url1=this.basePath +"zoy_admin/getDueHistory";
        return  this.httpclient.post<any>(
            url1,
            {
               headers:ServiceHelper.buildHeaders(),
    ...
    public getRefundHistory(): Observable<any> {
        const url1=this.basePath +"zoy_admin/getRefundHistory";
          return  this.httpclient.post<any>(
              url1,
              {
                 headers:ServiceHelper.buildHeaders(),
